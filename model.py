...
from torchvision.models.detection import fasterrcnn_mobilenet_v3_small_fpn, FasterRCNN_MobileNet_V3_Small_FPN_Weights
...
model.eval() # Set to evaluation mode if inference mode
...
# Load the ResNet50 model and move it to the device 
...
csv_file = 'ResNet50_Aug_test.csv' 
...
fasterrcnn.train() # Set the model to training mode